...
const MedicalAILandingPage = ({ setMedicalData }) => {
  ...
  const downloadSampleReport = () => {
    ...
    link.href = "/report-sample.png";
    link.download = "sample-medical-report.png";
                ...
                <div className="lg:w-1/2 mb-12 lg:mb-0">
                  <div className="max-w-lg">
                    ...
                    <div className="mt-6 pt-6 border-t border-white/10">
                      <p className="text-sm text-gray-400 mb-3">Want to test first?</p>
                      <button
                        onClick={downloadSampleReport}
                        className="w-full px-6 py-3 rounded-lg bg-white/10 hover:bg-white/15 transition-all border border-white/20 font-medium flex items-center justify-center gap-2"
                      >
                        <svg
                          className="w-5 h-5"
                          fill="none"
